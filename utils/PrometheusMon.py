...
class PrometheusMon:
    def __init__(self, bot) -> None:
        self.command_counter = prom.Counter("artbot_command_counter",
                                            "Number of commands run",
                                            ["command_name", "guild_id"])
        self.word_counter = prom.Counter("artbot_word_counter",
        ...
        self.bot_welcome_mute = prom.Gauge("artbot_welcome_mute", "How new members are temp-muted", ["guild_id"])
